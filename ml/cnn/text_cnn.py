...
class TextCNN(object):
    ...
    def __init__(
      ...
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        self.h_pool_flat = tf.reshape(self.h_pool, [-1, num_filters_total],name="output_features")
        ...
        #TODO: define a new cost function for the semi supervised learning
    ...
    def getCost(self):
        ...
        f1 = tf.placeholder(tf.float32, [num_classes, None])
        f2 = tf.placeholder(tf.float32, [1, None])
